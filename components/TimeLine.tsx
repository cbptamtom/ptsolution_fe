		...
		<div className="-my-6">
			{items.map((item, index) => (
				<div key={index} className="relative pl-8 sm:pl-32 py-6 group">
					<div className="font-caveat font-medium text-2xl dark:text-green-600 text-green-800 mb-1 sm:mb-0">
						{item.title}
					</div>
					...
					<div className="md:text-lg lg:text-xl text-slate-600 dark:text-slate-400">{item.description}</div>
				</div>
			))}
		</div>
	);

...
const About = () => {
	const logos = [
		...
		{ src: "/logo-python.svg", alt: "Python", width: 59, height: 59, href: "https://www.python.org/" },
		{ src: "/logo-github.svg", alt: "GitHub", width: 59, height: 59, href: "https://github.com/" },
		{ src: "/logo-react.svg", alt: "React", width: 59, height: 59, href: "https://reactjs.org/" },
		{ src: "/logo-postgresql.svg", alt: "PostgreSQL", width: 59, height: 59, href: "https://www.postgresql.org/" },
		{
			src: "/logo-revit.svg",
			alt: "Revit",
			width: 59,
		...
		{ src: "/logo-enscape.svg", alt: "Enscape", width: 59, height: 59, href: "https://enscape3d.com/" },
		{
		...
		{ src: "/logo-nodejs.svg", alt: "Node.js", width: 219, height: 59, href: "https://nodejs.org/" },
		{ src: "/logo-nextjs.svg", alt: "Next.js", width: 219, height: 59, href: "https://nextjs.org/" },
		{ src: "/logo-mongodb.svg", alt: "MongoDB", width: 219, height: 59, href: "https://www.mongodb.com/" },
	];

	return (
		<>
			<section id="about-me" className="lg:mt-44 lg:mb-16 ">
				<div className="flex flex-col items-center gap-4 mx-auto max-w-screen-xl px-4 ">
					...
					<div className="max-w-4xl lg:max-w-7xl font-light  md:text-lg lg:text-xl ">
						<div className="max-w-4xl lg:max-w-7xl  lg:mb-8">
							<div className=" md:text-lg lg:text-xl text-slate-600 dark:text-slate-400  ">
								...
								<div className=" block mt-3 font-bold ">@I familiar with....</div>
							</div>
						</div>
					</div>
